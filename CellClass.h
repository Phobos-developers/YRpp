...
#define ISTILE(tileset, addr) \
	...
	bool IsClearToMove(SpeedType speedType, bool ignoreInfantry, bool ignoreVehicles, int zone = -1, MovementZone movementZone = MovementZone::Normal, int level = -1, bool isBridge = true)
		{ JMP_THIS(0x4834A0); }
